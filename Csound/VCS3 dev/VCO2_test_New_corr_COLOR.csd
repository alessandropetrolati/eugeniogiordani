...
gkjvert_0			invalue "_JVERT"
gkjvert			port gkjvert_0, 0.01
gkamp			invalue "_amp"		; VCO amp
gkfreq			invalue "_freq"	; VCO freq (normalized)

gkfreq  = gkfreq + 0.1 * gkjvert
...
gkphase_0		invalue "_PHS"
gkphase			port gkphase_0, 0.01
...
elseif 	(gkRAMP == 0 && gkSQUARE == 0 && gkSINE == 1 && gkNOISE == 0 ) then
   ...
   aout vco2 gkamp*0.5, kfreq_log,12 ,gkpwm
...
kscl scale gkpwm, 0.18 , 0.01 
outvalue "_VAL", kscl
aout limit aout, -0.3, 0.5


 else

;kscl = 0.25 - 0.24 * gkpwm
;aout limit aout -1, 0.1	
endif
;	
sine:	
aout tone aout, 2300
	...
	;aout	vco2 gkamp*0.5, kfreq_log,2,gkpwm	; Use a square sawtooth waveform.
	;aout	tonex aout, 300,3
	;aout   dcblock aout
	
	
elseif 	(gkRAMP == 0 && gkSQUARE == 0 && gkSINE == 0 && gkNOISE == 1 ) then	
	
	;aout   atone aout, 20 ;  for test
	;aout   pareq aout, 16000, 6,0.5,2
...
aosc    vco2 ireson_OSC_amp*kamposc_exp, gkcut, 12
aosc    tone aosc, 200
...
asig_LO pareq asig, 900, 1-abs(gkTONE), 0.5, 2

asig_HI pareq asig, 900, 1-gkTONE, 0.5, 1
...
<bsbPanel>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <width>322</width>
  <height>163</height>
  <uuid>{769eb3a1-9c19-4123-8aec-71e69cfc98d9}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>COLOR</label>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>VCO2 Test + VCF + TONE COLOR</label>
  <alignment>left</alignment>
...
On/Off</label>
 ...
 <bsbObject version="2" type="BSBVSlider">
  <objectName>_JVERT</objectName>
  <x>514</x>
  <y>635</y>
  <width>20</width>
  <height>100</height>
  <uuid>{4e126328-6a69-4d9f-b307-0d1cab26d990}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
 ...
 <bsbObject version="2" type="BSBDisplay">
  ...
  <width>80</width>
  <height>25</height>
  <uuid>{1b958179-c4d5-4b51-b98a-05318f7e5b31}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>0.000</label>
 ...
 <bsbObject version="2" type="BSBDisplay">
  <objectName>_VAL</objectName>
  <x>363</x>
  <y>606</y>
  <width>80</width>
  <height>25</height>
  <uuid>{b07ab8a6-93da-4250-865c-03e8bd8eb6d0}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>0.000</label>
 ...
 <bsbObject version="2" type="BSBVSlider">
  <objectName>_PHS</objectName>
  <x>973</x>
  <y>234</y>
  <width>20</width>
  <height>100</height>
  <uuid>{c9cb2edb-dfa2-40c9-b5a8-6843899dbec6}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <minimum>0.00000000</minimum>
 ...
 <bsbObject version="2" type="BSBKnob">
  <objectName>_TONE</objectName>
  <x>118</x>
  <y>645</y>
  <width>80</width>
  <height>80</height>
  <uuid>{f016e526-17aa-4069-b7e1-0826684f7bd2}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <minimum>-1.00000000</minimum>
 ...
 <bsbObject version="2" type="BSBDisplay">
  ...
  <width>80</width>
  <height>25</height>
  <uuid>{54c24456-3669-4810-baf3-91a3ca3750e8}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>-0.040</label>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <width>59</width>
  <height>25</height>
  <uuid>{a9dad4d8-296f-49be-b017-18ed9117ec10}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>LO</label>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <width>59</width>
  <height>25</height>
  <uuid>{ef866767-83a5-4de6-bf2f-d6419e594f3f}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>0</midicc>
  <label>HI</label>
